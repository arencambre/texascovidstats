...
**Temporarily, some plots are missing or inaccurate.** The data from the state does not include the year, so the script is having a hard time discerning 2020 data from 2021 data. I will wait until new data is published with 2021 dates before I decide how to fix. More info at https://github.com/arencambre/texascovidstats/issues/5.
