...
```{r get data and process it, include=FALSE, echo=FALSE}
# first do state data
# fatality data
...
```{r Texas COVID-19-related hospitalizations, fig.width=9, echo=FALSE}
...
```{r Texas COVID-19-related hospitalizations TSA regions T V, fig.width=9, echo=FALSE}
...
```{r Texas COVID-19-related hospitalizations TSA region I, fig.width=9, echo=FALSE}
...
```{r Texas COVID-19-related hospitalizations TSA region J, fig.width=9, echo=FALSE}
...
```{r Texas COVID-19-related hospitalizations TSA region E, fig.width=9, echo=FALSE}
...
```{r Texas COVID-19-related hospitalizations TSA region G, fig.width=9, echo=FALSE}
...
```{r Tyler/Longview TSA region COVID-19-related hospitalizations by day, echo=FALSE}
comprehensive_hospitalization_data_long %>%
...
```{r Dallas/Fort Worth TSA region COVID-19-related hospitalizations by day, echo=FALSE}
comprehensive_hospitalization_data_long %>%
...
```{r Dallas/Fort Worth TSA region COVID-19-related hospitalizations by CDC week, echo=FALSE}
comprehensive_hospitalization_data_long %>%
...
```{r Rate of hospitalization change in the Dallas/Forth Worth TSA region, message=FALSE, warning=FALSE, echo=FALSE}
...
```{r percent of beds occupied by COVID patients, message=FALSE, warning=FALSE, echo=FALSE}
...
```{r percent of beds occupied by COVID patients 20 most recent days, message=FALSE, warning=FALSE, echo=FALSE}
...
```{r Dallas County COVID-19 fatalities by week, echo=FALSE}
fatality_data_long %>%
  group_by(county,
           week) %>%
...
```{r Dallas County COVID-19 fatalities, message=FALSE, echo=FALSE}
fatality_data_long %>%
  filter(county == "DALLAS") %>%
...
```{r Texas statewide COVID-19 testing, by day, echo=FALSE}
...
```{r Texas pct of positive COVID-19 tests, message=FALSE, warning=FALSE, echo=FALSE}
aggregated_case_data %>%
...
```{r Dallas County COVID-19 tests and cases, warning=FALSE, echo=FALSE}
case_data_long %>%
  bind_rows(test_data_long) %>%
...
```{r Dallas County COVID-19 cases, warning=FALSE, echo=FALSE}
case_data_long %>%
...
```{r Dallas County positivity, warning=FALSE, echo=FALSE}
...
```{r Hospitalizations in the City of Dallas ugly chart, echo=FALSE, message=FALSE, warning=FALSE}
dallas_data %>%
  ...
  labs(title = "Hospitalizations in the City of Dallas",
       subtitle = "This includes *all* hospitalizations, not just COVID-19") +
  expand_limits(y = 0) +
...
```{r Hospitalizations in the City of Dallas, fig.width=10, echo=FALSE}
...
```{r ICU hospitalizations in the City of Dallas, echo=FALSE, message=FALSE, warning=FALSE}
dallas_data %>%
  filter(name %in% c("ICU Beds Occupied",
                     "Total ICU Beds")) %>%
  # filter(!(name %in% c("ICU Beds Occupied %",
  ...
  labs(title = "ICU hospitalizations in the City of Dallas",
       subtitle = "This includes all ICU hospitalizations, not just COVID-19")
