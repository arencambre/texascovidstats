...
# and ww is the epimeological week. Dates before the first Monday of
...
epi_week_string <- function(date_value) {
  ifelse(epiweek(date_value) == 53 & month(date_value) == 1,
         paste0(year(date_value) - 1,"-",epiweek(date_value)),
         paste0(year(date_value),"-",epiweek(date_value)))
}
...
# columns 2 - 301 are 2020 dates
names(fatality_data)[2:301] <- paste0("2020-", names(fatality_data)[2:301])
names(case_data)[2:301] <- paste0("2020-", names(case_data)[2:301])
# columns 302 and on are 2021 dates
names(fatality_data)[302:dim(fatality_data)[2]] <- paste0("2021-", names(fatality_data)[302:dim(fatality_data)[2]])
names(case_data)[302:dim(case_data)[2]] <- paste0("2021-", names(case_data)[302:dim(case_data)[2]])
